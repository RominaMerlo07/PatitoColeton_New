...
{
    public partial class frmInformeProgreso_Consultar : Form
    {
        ...
        public frmInformeProgreso_Consultar()
        {
            InitializeComponent();
        }

        private void frmInformeProgreso_Consultar_Load(object sender, EventArgs e)
        {
            Inicializar();
        ...
        private void dgv_Informe_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void btnGInf_Editar_Click(object sender, EventArgs e)
        {
            ...
            InformeProgreso InformeProgreso = new InformeProgreso(2, semestre);
        }
    }
}
