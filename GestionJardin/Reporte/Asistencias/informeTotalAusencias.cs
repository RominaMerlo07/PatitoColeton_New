...
{
    public partial class informeTotalAusencias : Form
    {
         
            logAsistencia logAsistencia = new logAsistencia();           
            public informeTotalAusencias(string idSala, string fechaDesde, string fechaHasta)
            {
                InitializeComponent();
                DataSet informe = logAsistencia.InformeTotalAsistencias(idSala, fechaDesde, fechaHasta);
                var reportPath = "GestionJardin.Reporte.Asistencias.graficoTotalAusencias.rdlc";
